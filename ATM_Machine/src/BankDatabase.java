...
public class BankDatabase
{
    ...
    public BankDatabase()
    {
        ...
        Account accounts1 = new Account("Yash Pawar", 12345, 1410, 10000.0, 12000.0, 0);
        Account accounts2 = new Account("Neha Pawar", 98765, 2510, 12200.0, 12200.0, 0);
        Account accounts4 = new Account("Admin Panel1", 96452, 0, 0, 0, 1);
